...
<div class="entregables-index">
    ...
    <p>
        <?= 
            Html::a('Crear tareas desde Excel', 'create-excel', [
                'id' => '_formcreate',
                'class' => 'btn btn-success',
                /* 'value' => Yii::$app->urlManager->createUrl('entregables/CreateExcel'),
       ...
       /*  Html::a('Create Proyectos', ['create2'], ['class' => 'btn btn-success'])  */
            ?>
    </p>
    <?php } ?>
